  ...
  <body>
    <div class="ensemble">
      ...
      <div class="bloc">
            ...
            Gender :<?= $product['gender'] ?><br><hr>
        </div>
        <form class="bloc" action="insertStock.php?numprod=<?= $product['id']?>" method="post">
          Select size :  <br>
          <select name="size">
          ...
          <p>Add stock : <input id="name" type="text" name="stock"></p>
          <p><input type="submit" value="Add stock"></p>
        </form>
        <div class="bloc">
          <?php
            ...
            while($size = $pdoStatSize-> fetch()){?>
              ...
              <?php
                ...
                <a class="supp" href="verifSuppStock.php?numstock=<?= $product['id']?>"> Supprimer</a></p>
              <?php }}?>
      </div>
    </div>
  </body>
